...
type CompleteNewTeamMemberRegistrationDTO struct {
	...
	TeamLeadEmail       string   `validate:"email" json:"team_lead_email"`
	...
	HackathonExperience string   `validate:"required" json:"hackathon_experience"`
	YearsOfExperience   int      `validate:"required" json:"years_of_experience"`
	FieldOfStudy        string   `validate:"required" json:"field_of_study"`
	PreviousProjects    []string `validate:"required" json:"previous_projects"`
}
