...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/routes.InitiateEmailVerificationSuccessResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/routes.InitiateEmailVerificationFailureResponse"
                        }
                    },
                    "404": {
    ...
    "definitions": {
        ...
        "routes.InitiateEmailVerificationFailureResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
        ...
        "routes.InitiateEmailVerificationSuccessResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
                ...
                "data": {
                    "$ref": "#/definitions/routes.InitiateEmailVerificationSuccessResponseData"
                },
                "message": {
                    "type": "string"
                }
        ...
        "routes.InitiateEmailVerificationSuccessResponseData": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
